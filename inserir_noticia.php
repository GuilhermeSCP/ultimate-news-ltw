				...
				<div class="wrapper">
					...
					<div class="conteudo_principal">
						<div class="conteudo_centro">
							...
							<form id="formulario" method="post" action="submeter_noticia.php">
								<fieldset>
									<div class="field">
										<label>Introduza o titulo da notícia:</label>
										<input type="text" name="not_tit" cols="50" maxlength="255"/>
									</div>
									<div class="field">
									...
									<div class="field">
										...
										<input rows="10" cols="50" name="not_tags">
										</input>
									</div>
									<div class="field">
										<label>Introduza a fonte ou bibliografia:</label>
										<input type="text" name="not_fonte" cols="50" maxlength="1000"/>
									</div>
									<div class="field">
										<input type="submit" value="Escrever notícia"/>
									</div>
								</fieldset>
							</form>	
						</div>	
